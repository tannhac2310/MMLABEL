...
type Service interface {
	...
	CalcOEEByAssignedWork(ctx context.Context, dateFrom string, dateTo string, limit int64, offset int64) (map[string]model.OEE, map[string]model.SummaryOEE, int64, error)
}
